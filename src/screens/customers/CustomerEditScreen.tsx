...
import { Text, Button, TextInput, HelperText, Divider, RadioButton, Avatar, Snackbar } from 'react-native-paper';
...
const validationSchema = Yup.object().shape({
  ...
  annual_income: Yup.number().positive('年收入必须为正数').nullable().typeError('请输入有效的数字'),
...
const CustomerEditScreen = () => {
  ...
  const route = useRoute<RouteProp<CustomersStackParamList, typeof ROUTES.CUSTOMERS.EDIT>>();
  ...
  useEffect(() => {
    if (customer) {
      formik.setValues({
        ...
        status: customer.status || CustomerStatus.POTENTIAL,
        identification_number: customer.identification_number || '',
        identification_type: customer.identification_type || '',
        annual_income: customer.annual_income ? customer.annual_income.toString() : '',
  ...
  if (isLoadingCustomer) {
    return <Loading loading={true} message="加载客户信息中..." />;
  }
    ...
    return (
      <Container>
        ...
        <View style={[styles.content, styles.centerContent]}>
          <Text style={styles.errorText}>加载客户信息失败</Text>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.content}>
          ...
          <View style={styles.avatarContainer}>
            ...
            <Text style={styles.avatarLabel}>点击更改头像</Text>
          </View>
          ...
          >
            <View style={styles.radioGroup}>
              <View style={styles.radioButton}>
                <RadioButton value={CustomerStatus.ACTIVE} />
                <Text>活跃</Text>
              </View>
              <View style={styles.radioButton}>
                <RadioButton value={CustomerStatus.INACTIVE} />
                <Text>非活跃</Text>
              </View>
              <View style={styles.radioButton}>
                <RadioButton value={CustomerStatus.POTENTIAL} />
                <Text>潜在</Text>
              </View>
              <View style={styles.radioButton}>
                <RadioButton value={CustomerStatus.VIP} />
                <Text>VIP</Text>
              </View>
            </View>
          </RadioButton.Group>
